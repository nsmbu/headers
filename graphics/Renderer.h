...
public:
    ...
    public:
        ...
        LayerSetter(RenderObjLayerBase* layer)
        {
            Renderer::instance()->setLayer(layer, render_pass_type);
        }
...
public:
    ...
    // Address: 0x024FAA50
    void setLayer(agl::lyr::Layer* layer, RenderPassType render_pass_type);
    // Address: 0x024FAB4C
    void resetLayer();
