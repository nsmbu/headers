...
public:
    ...
    // Address: 0x0272D730
    virtual void setAwaHit(Actor* awa); // Called when bubble hits the actor and either catches it or breaks
    // Address: 0x0272D734
    virtual void awaCatchMove(Actor* awa); // Called as the bubble is swallowing the actor
    // Address: 0x0272D700
    virtual void setAwaCatchEnd(Actor* awa); // Called when the bubble finishes swallowing the actor, actor should die
    // Address: 0x0272D738
    virtual void setAwaInvalid(Actor* awa); // Called when the bubble cannot catch the actor and breaks instead
