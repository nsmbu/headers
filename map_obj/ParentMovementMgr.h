...
public:
    ...
    // Address: 0x0284B824
    void init(const sead::Vector3f& position,u32 movement_mask,s8 movement_id,sead::Vector3f *pivot_center,u8 param_6 = 0,u8 param_7 = 0,u8 param_8 = 0,bool param_9 = true);
