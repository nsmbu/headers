...
protected:
    ...
    sead::FixedRingBuffer<s32, cPlayerNum> mCourseOutList;
    sead::FixedRingBuffer<s32, cPlayerNum> mDemoNoRingBuffer;
    sead::FixedRingBuffer<s32, cPlayerNum> mDemoNoRingBufferCopy;
...
static_assert(sizeof(PlayerDemoMgr) == 0x1F4, "PlayerDemoMgr size mismatch");
