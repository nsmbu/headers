...
public:
    ...
    // Address: 0x0291A78C
    void getFaceMtx(sead::Matrixf* mtx);
    ...
    // Address: 0x0291B010
    void createPlayerModel(const sead::PtrArray<ModelResource>* anim_mdl_res_array);
    ...
    // Address: 0x0291BFF4
    bool getLowWalkAnmName(sead::BufferedSafeString* anm_name, s32 anm_id, bool body);
    ...
    // Address: 0x0291E8EC
    void setTailAnm(const ModelResource* anm_res, const sead::SafeString& anm_name, FrameCtrl::PlayMode mode, f32 rate, f32 frame);
    ...
    // Address: 0x0291F734
    void setStarAnm(AnimModel* anim_model, const ModelResource* mdl_res, const sead::SafeString& name, f32 frame);
    // Address: 0x0291F7B0
    void removeStarAnm(AnimModel* anim_model);
    ...
    // Address: 0x0291FAB0
    void removeStarAnm(AnimModel* head_anim_model, AnimModel* body_anim_model);

    // Address: 0x0291F9C0
    void resetTevKColor3Alpha(Model* model);
    ...
    void getJointMtx(sead::Matrixf* mtx, JointID id)
    {
        PlayerModelBase::getJointMtx(mtx, mJointMap[id]);
    }

    void getJointPos(sead::Vector3f* pos, JointID id)
    {
        PlayerModelBase::getJointPos(pos, mJointMap[id]);
    }
    ...
    {
        PlayerModelBase::getJointPos(pos, name);
    }
