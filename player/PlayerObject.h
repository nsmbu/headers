...
public:
    ...
    {
        if (setFlyDamageActionImpl_Part2(type, setFlyDamageActionImpl_Part1(type, actor)))
            return true;
        return false;
    }
    ...
    // Address: 0x0292D2F8
    bool setLiftUpTotten(Actor* actor);
    // Address: 0x0292D474
    bool setCarryToLiftUp();

    // Address: 0x0292D534
    bool checkCarryActor(PlayerObject* player);
    ...
    // Address: 0x0292D8BC
    void checkSpinLiftUpReserve(ActorCollisionCheck* cc);
    // Address: 0x0292D9A4
